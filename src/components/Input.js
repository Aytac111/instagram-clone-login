    ...
    useEffect(() => {
     ...
     return (
        <label className='block relative flex bg-zinc-50 border rounded-sm focus-within:border-gray-400 '>
            ...
            <small className='absolute top-1/2 text-xs left-[9px] cursor-text pointer-events-none text-gray-400 -translate-y-1/2 transition-all peer-valid:text-[10px] peer-valid:top-2'>{label}</small>
